  ...
  nodes: {
    ...
    b2: {
      ...
      options: [
        ...
        { text: "Honestly, once the event happens and the check arrives, nobody thinks about the percentage anymore. The experience and the money speak for themselves.",
          next: "c2", scores: { empathy: 0, discovery: 0, framing: 0, momentum: 0 }, rating: "poor",
    ...
    a3: {
      ...
      options: [
        ...
        { text: "Great! I'll also include some testimonials from principals at similar schools. The more info, the better for making the case, right?",
  ...
  nodes: {
    start: {
      ...
      options: [
        ...
        { text: "I hear you. What if we just focused on the event day and the fundraising piece? We can customize around your needs completely.",
    ...
    a1: {
      ...
      options: [
        ...
        { text: "What if the classroom visits were just two or three times during the two weeks instead of daily? We can be very flexible on the schedule.",
    ...
    b1: {
      ...
      options: [
        ...
        { text: "Yes! And it's really easy — they just press play. It takes almost no effort on the teacher's part. Want me to show you a sample?",
    ...
    c1: {
      ...
      options: [
        ...
        { text: "Our events are a premium production — trained team, professional equipment, music, themed t-shirts, the whole experience. Schools typically raise $35K-$50K with a 98% collection rate.",
    ...
    a3: {
      ...
      options: [
        ...
        { text: "Great! Let me set up a pre-meeting with you and your team to walk through the whole program. When works this month?",
...
const S3 = makeScenario(
  ...
  ["Don't badmouth competitors", "Ask about the bad experience", "Local franchise credibility", "Earning the right to come back", "Patience as strategy"],
  {
    ...
    a2: { speaker: "them", name: "Mrs. Gutierrez", text: "That's exactly right. They didn't respect my building. And after that, I told the district: no more outside programs. Period.", options: [
      ...
      { text: "I completely understand. Would it help if I connected you with a principal at another school who had a similar concern and has been with us for three years?", next: "a3b", scores: { empathy: 1, discovery: 0, framing: 1, momentum: 1 }, rating: "okay",
...
const S6 = makeScenario(
  ...
  ["Positioning as complement, not replacement", "Discovering the latent pain", "The status quo calculation", "Social proof from the Apex network", "Planting the seed for spring"],
  {
    start: { speaker: "them", name: "Mrs. Davidson", text: "Thanks for coming by. Sarah mentioned you, so I wanted to be polite — but I'll be upfront: we're pretty set with our fundraiser. We've done cookie dough sales for six years and the parents know the drill.", options: [
      ...
      { text: "Makes sense. Roughly how much does it bring in each year?", next: "c1", scores: { empathy: 0, discovery: 1, framing: 0, momentum: 0 }, rating: "poor",
    ...
    a1: { speaker: "them", name: "Mrs. Davidson", text: "It's predictable. Parents know what to expect, the PTA runs it, and we don't have to reinvent the wheel every year. [pause] But honestly... participation has been dropping. Last year only about 40% of families bought anything. And my PTA president is pretty burned out from doing all the coordination.", options: [
      ...
      { text: "What if you could keep the cookie dough sale AND add something that re-energizes the school? They work great together — different times of year, totally different experience.", next: "a1b", scores: { empathy: 1, discovery: 0, framing: 2, momentum: 1 }, rating: "okay",
